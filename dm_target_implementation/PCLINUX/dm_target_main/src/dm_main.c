...
#define DATE_KEYWORD "$Date: 2015-12-17 11:28:03 +0100 (jeu. 17 déc. 2015) $"
...
#ifndef IGD_ENABLED_ON_TR069_AGENT
#define IGD_INFO "without UPnP IGD"
#else
#define IGD_INFO "with UPnP IGD"
#endif
     ...
     char* env[] UNUSED)
{
   ...
   DM_ENG_InitLevel level = DM_ENG_InitLevel_REBOOT; // par d�faut, on consid�re que l'agent d�marre suite � un REBOOT
